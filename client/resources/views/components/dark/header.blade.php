<nav id="gtco-header-navbar" class="navbar navbar-expand-lg py-4 bg-dark-custom text-white navbar-dark">
    <div class="container">
...
<div class="jumbotron jumbotron-dark d-flex align-items-center"
    style="background-image: url('{{ asset('img/header/dark/header-' . rand(1, 6) . '.png') }}')">
