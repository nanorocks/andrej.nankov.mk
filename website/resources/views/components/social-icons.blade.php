    ...
    @foreach ($links as $link)
        ...
        >
            @switch($link->icon)
                ...
                @case('book-open')
                    {{-- Lucide: book-open --}}
                    <svg class="fill-none stroke-current" viewBox="0 0 24 24" aria-hidden="true" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 7v14" />
                        <path d="M3 18a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-5a4 4 0 0 0-4 4 4 4 0 0 0-4-4Z" />
                    </svg>
                    @break
                @case('github')
