            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        ...
                        <p class="mt-2 text-sm text-base-700">A list of all the {{ __('Services') }}.</p>
                    </div>
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <a type="button" wire:navigate href="{{ route('services.create') }}"
                            ...
                            <table class="w-full divide-y divide-base-300">
                                ...
                                <tbody class="divide-y divide-base-200 bg-base-300">
                                    @foreach ($services as $service)
                                        <tr class="even:bg-base-50" wire:key="{{ $service->id }}">
                                            <td
                                            ...
                                            <td
                                                ...
                                                <a wire:navigate href="{{ route('services.show', $service->id) }}"
                                                ...
                                                <a wire:navigate href="{{ route('services.edit', $service->id) }}"
