<div class="space-y-6 pl-1">
    ...
    <div>
        ...
        <x-text-input wire:model="form.content" id="content" name="content" type="text" class="mt-1 block w-full"
    ...
    <div>
        ...
        <x-text-input wire:model="form.excerpt" id="excerpt" name="excerpt" type="text" class="mt-1 block w-full"
            autocomplete="excerpt" placeholder="Excerpt" />
        @error('form.excerpt')
            <x-input-error class="mt-2" :messages="$message" />
        @enderror
    </div>
    ...
    <div>
        ...
        <x-text-input wire:model="form.tags" id="tags" name="tags" type="text" class="mt-1 block w-full"
            autocomplete="tags" placeholder="Tags" />
        @error('form.tags')
            <x-input-error class="mt-2" :messages="$message" />
        @enderror
    </div>
    <div>
        ...
        <x-text-input wire:model="form.category_id" id="category_id" name="category_id" type="text"
            class="mt-1 block w-full" autocomplete="category_id" placeholder="Category Id" />
    ...
    <div>
        ...
        <x-text-input wire:model="form.is_draft" id="is_draft" name="is_draft" type="text" class="mt-1 block w-full"
            autocomplete="is_draft" placeholder="Is Draft" />
        @error('form.is_draft')
            <x-input-error class="mt-2" :messages="$message" />
        @enderror
    </div>
    ...
    <div>
        ...
        <x-text-input wire:model="form.featured_image" id="featured_image" name="featured_image" type="text"
            class="mt-1 block w-full" autocomplete="featured_image" placeholder="Featured Image" />
    ...
    <div>
        ...
        <x-text-input wire:model="form.media" id="media" name="media" type="text"
            class="mt-1 block w-full" autocomplete="media" placeholder="Media" />
        @error('form.media')
            <x-input-error class="mt-2" :messages="$message" />
        @enderror
    </div>
    <div>
        ...
        <x-text-input wire:model="form.seo_page_id" id="seo_page_id" name="seo_page_id" type="text"
            class="mt-1 block w-full" autocomplete="seo_page_id" placeholder="Seo Page Id" />
