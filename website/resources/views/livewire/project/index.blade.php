            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <a type="button" wire:navigate href="{{ route('projects.create') }}"
                            ...
                            <table class="w-full divide-y divide-base-300">
                                ...
                                <tbody class="divide-y divide-base-200 bg-base-300">
                                    @foreach ($projects as $project)
                                        <tr class="even:bg-base-50" wire:key="{{ $project->id }}">
                                            <td
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-base">
                                                {{ $project->end_date }}</td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-base">
                                                {{ $project->project_url }}</td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-base">
                                                {{ $project->image_url }}</td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-base">
                                                {{ $project->status }}</td>
                                            <td
                                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-base flex mt-3">
                                                <a wire:navigate href="{{ route('projects.show', $project->id) }}"
                                                ...
                                                <a wire:navigate href="{{ route('projects.edit', $project->id) }}"
