            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <a type="button" wire:navigate href="{{ route('users.index') }}" class="btn btn-primary text-base">Back</a>
                    </div>
                </div>
                            ...
                            <div class="mt-6 border-t border-base-100">
                                <dl class="divide-y divide-base-100">
                                    ...
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        ...
                                        <dd class="mt-1 text-sm leading-6 text-base-700 sm:col-span-2 sm:mt-0 uppercase">
                                            {{ $user->role ?? 'N/A' }}</dd>
                                    </div>
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
