<div class="space-y-6 pl-1">
    ...
    <div>
        ...
        <x-text-input wire:model="form.video_url" id="video_url" name="video_url" type="text"
            class="mt-1 block w-full" autocomplete="video_url" placeholder="Video Url" />
    ...
    <div>
        ...
        <x-text-input wire:model="form.thumbnail_url" id="thumbnail_url" name="thumbnail_url" type="text"
            class="mt-1 block w-full" autocomplete="thumbnail_url" placeholder="Thumbnail Url" />
