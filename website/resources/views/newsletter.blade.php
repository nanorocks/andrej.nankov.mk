<x-guest-layout>
    ...
    <section class="public-panel grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.8fr)] lg:gap-14" aria-labelledby="newsletter-title">
        <div>
            ...
            <h1 id="newsletter-title" class="public-section-title mt-8">{{ $newsletter->headline }}</h1>
        ...
        <aside class="self-start rounded-2xl border border-white/10 bg-black/20 p-6 sm:p-8" aria-label="Newsletter subscription form">
